...
export const schema = z.object({
	...
	preOperativeHistory: z.object({
		...
		otherInformation: z.object({
			otherMedicalTreatment: z.object({
	...
	physicalExamination: z.object({
		...
		laboratories: z
			.object({
				hematology: z
					.object({
						hgb: z.string().optional(),
						hct: z.string().optional(),
						wbc: z.string().optional(),
						plt: z.string().optional(),
						neut: z.string().optional(),
						lym: z.string().optional(),
						pt: z.string().optional(),
						ptt: z.string().optional()
					})
					.optional(),
				biochemistry: z
					.object({
						...
						glu: z.string().optional(),
						chol: z.string().optional(),
				...
				urinalysis: z
					.object({
						...
						cho: z.string().optional(),
						chon: z.string().optional(),
						rbc: z.string().optional(),
						wbc: z.string().optional(),
						bact: z.string().optional(),
